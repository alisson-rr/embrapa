            ...
            <div className="flex items-center justify-between h-full">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-3xl font-bold text-[#008247]">79</span>
            ...
            <div className="flex items-center justify-between h-full">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-3xl font-bold text-[#FDB022]">55</span>
                  <span className="text-gray-500">/100</span>
                </div>
            ...
            <div className="flex items-center justify-between h-full">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-3xl font-bold text-[#D92D20]">19</span>
                  <span className="text-gray-500">/100</span>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="h-32 flex items-end justify-center">
                <div className="w-20 bg-[#008247] rounded-t" style={{ height: '80%' }}></div>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="h-32 flex items-end justify-center">
                <div className="w-20 bg-blue-500 rounded-t" style={{ height: '60%' }}></div>
              </div>
            ...
            <div className="text-center">
              ...
              <div className="h-32 flex items-end justify-center">
                <div className="w-20 bg-orange-500 rounded-t" style={{ height: '40%' }}></div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-600">
                    <strong className="font-semibold">X% do faturamento é destinado a financiamentos</strong>
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <ArrowRight className="w-5 h-5 text-[#008247] mt-0.5 flex-shrink-0" />
                  <span className="text-sm text-gray-600">
                    Custo de produção da propriedade é R$ 1.000,00.
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <ArrowRight className="w-5 h-5 text-[#008247] mt-0.5 flex-shrink-0" />
