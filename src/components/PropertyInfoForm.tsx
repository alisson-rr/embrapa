        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-sm text-primary mt-1 cursor-pointer">
              Não sei o município, quero selecionar no mapa
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) => handleInputChange("permanentProtectionArea", e.target.value)}
              onKeyPress={handleNumberKeyPress}
              placeholder="Ex: 90"
              className="mt-2"
            />
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => handleInputChange("legalReserveArea", e.target.value)}
              onKeyPress={handleNumberKeyPress}
              placeholder="Ex: 0"
              className="mt-2"
            />
            ...
            <div className="mt-2 space-y-3">
              <div className="flex flex-col space-y-2">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={formData.pastureTypes.includes("Naturais")}
                    onChange={() => handlePastureTypeToggle("Naturais")}
                    className="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary focus:ring-2"
                  />
                  <span className="text-sm font-medium text-gray-700">Naturais</span>
                </label>
                
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={formData.pastureTypes.includes("Artificiais")}
                    onChange={() => handlePastureTypeToggle("Artificiais")}
                    className="w-4 h-4 text-primary bg-gray-100 border-gray-300 rounded focus:ring-primary focus:ring-2"
                  />
                  <span className="text-sm font-medium text-gray-700">Artificiais</span>
                </label>
              </div>
