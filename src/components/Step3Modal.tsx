...
const Step3Modal = ({ onContinue }: Step3ModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <DialogTitle className="sr-only">Fase 3: Informações econômicas</DialogTitle>
        {/* Close button */}
        <button
          onClick={handleClose}
        ...
        <div className="flex flex-col bg-white">
          ...
          <div className="px-6 pb-3 flex justify-center">
            <div className="relative overflow-hidden" style={{ borderRadius: '16px', width: '316px', height: '316px' }}>
              <img
                src="/passo3.png"
                alt="Fase 3: Informações econômicas - Ilustração com gráficos e dados financeiros"
