...
const Step4Modal = ({ onContinue }: Step4ModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <DialogTitle className="sr-only">Fase 4: Informações sociais</DialogTitle>
        {/* Close button */}
        <button
          onClick={handleClose}
        ...
        <div className="flex flex-col bg-white">
          ...
          <div className="px-6 pb-3 flex justify-center">
            <div className="relative overflow-hidden" style={{ borderRadius: '16px', width: '316px', height: '316px' }}>
              <img
                src="/passo4.png"
                alt="Fase 4: Informações sociais - Ilustração com pessoas e dados sociais"
